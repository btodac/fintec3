...
# Ig service manager
# Maintains ig_service and if requested ig stream service
# Must store subscriptions to reapply if restarted
...
class IGStreamService(object):
    ...
    def unsubscribe_all(self):
        ...
        subscription_keys = list(self.ls_client._subscriptions.keys())
        for subcription_key in subscription_keys:
